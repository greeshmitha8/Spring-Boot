...
import com.example.ecomProject.server.Productservice;
@CrossOrigin
@RestController
@RequestMapping("/api")
public class Productcontroller {
    ...
    public ResponseEntity<byte[]> getProductById(@PathVariable int Productid){
        ...
        return ResponseEntity.ok().body(imageFile);// .contentType(MediaType.valueOf(product.getImageType()))
    ...
    public ResponseEntity<String> deleteProduct(@PathVariable int id){
        ...
        if(product!=null){
            ...
            return new ResponseEntity<>("Prodtuct not found", HttpStatus.BAD_REQUEST);
        }
    }
